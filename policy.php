		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
						<a href="index.php" class="logo" style="text-transform: uppercase">interest</a>
					</div>
					<!-- /logo -->
			...
			<div id="nav-bottom">
				<div class="container">
					...
					<ul class="nav-menu">
							...
							<div class="dropdown">
								<div class="dropdown-body">
									<ul class="dropdown-list">
										...
										<li><a href="news1.php.html">6 modern business nich...</a></li>
										

										<li><a href="news2.php.html">Dividends from state-o...</a></li>
										

										<li><a href="news3.php.html">How Deripaska won over...</a></li>
										

										<li><a href="news4.php.html">How did the market dec...</a></li>
										

										<li><a href="news5.php.html">What types of bonds ar...</a></li>
						...
						<li><a href="contact.php">contact.phs</a></li>
...
Final provision
The user can get any clarifications on issues of interest related to the processing of their personal data by contact.phing the Operator via e-mail policy@<span class="server-name"></span>.
 ...
 The current version of the Policy is freely available on the Internet at <span class="server-name"></span>/terms.php.
						</pre>
					</div>
					<!-- /post content -->
				</div>
				<div class="col-md-4">
							...
							<ul>
								<li>
									<a href="#" class="social-facebook">
										...
										<span>326.4K<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-twitter">
										<i class="fa fa-twitter"></i>
										<span>133.5<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-google-plus">
										<i class="fa fa-google-plus"></i>
										<span>117.6<br>Followers</span>
									</a>
								</li>
							</ul>
						</div>
					...
					<div class="aside-widget">
						...
						<div class="post post-widget">
							<a class="post-img" href="news1.php.html"><img src="./img/sharon-mccutcheon--8a5ej1-mmq-unsplash.jpg" alt=""></a>
							<div class="post-body">
								<h3 class="post-title"><a href="news1.php.html">6 modern business niches.</a></h3>
							</div>
						</div>
						<!-- /post -->
						...
						<!-- post -->
						<div class="post post-widget">
							<a class="post-img" href="news2.php.html"><img src="./img/michael-longmire-rhbvojnrqvg-unsplash.jpg" alt=""></a>
							<div class="post-body">
								<h3 class="post-title"><a href="news2.php.html">Dividends from state-owned companies. 50% of the net profit.</a></h3>
							</div>
						</div>
						<!-- /post -->
						...
						<!-- post -->
						<div class="post post-widget">
							<a class="post-img" href="news3.php.html"><img src="./img/zane-lee-npwahrwhyqc-unsplash.jpg" alt=""></a>
							<div class="post-body">
								<h3 class="post-title"><a href="news3.php.html">How Deripaska won over Potanin and Abramovich!</a></h3>
							</div>
						</div>
						<!-- /post -->
						...
						<!-- post -->
						<div class="post post-widget">
							<a class="post-img" href="news4.php.html"><img src="./img/robert-bye-6pv4ltew9gm-unsplash.jpg" alt=""></a>
							<div class="post-body">
								<h3 class="post-title"><a href="news4.php.html">How did the market decline affect the IPO? My results.</a></h3>
							</div>
						</div>
						<!-- /post -->
			...
			<div class="footer-bottom row">
				<div class="col-md-8 col-md-push-3">
					<ul class="footer-nav">
						...
						<li><a href="contact.ph.html">contact.phs</a></li>
						<li><a href="terms.php">Terms and conditions</a></li>
